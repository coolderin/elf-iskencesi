...
# Generated on: Sat Jul 20 13:36:56 CEST 2024 (Sat Jul 20 11:36:56 UTC 2024)
...
set logfile fv/PWM/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/PWM -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/apps/DDI231/23.11.000/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/apps/DDI231/23.11.000/GENUS231/tools.lnx86"
set env(CW_DIR) "/apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/apps/DDI231/23.11.000/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
read_library -liberty -both \
    /proj/dltyilki/tapeout/salihe/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/PWM.sv
elaborate_design -golden -root {PWM} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/PWM/fv_map.v.gz
elaborate_design -revised -root {PWM}
...
set_analyze_option -mapping_file fv/PWM/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.PWM.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.PWM.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.PWM.rtl.fv_map.rpt

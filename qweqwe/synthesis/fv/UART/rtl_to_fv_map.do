...
# Generated on: Fri Jul 19 12:24:57 CEST 2024 (Fri Jul 19 10:24:57 UTC 2024)
...
set logfile fv/UART/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/UART -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/UART.sv
elaborate_design -golden -root {UART} -rootonly 
...
set_analyze_option -mapping_file fv/UART/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.UART.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.UART.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.UART.rtl.fv_map.rpt

...
# Generated on: Fri Jul 19 13:10:30 CEST 2024 (Fri Jul 19 11:10:30 UTC 2024)
...
set logfile fv/uart_rx/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/uart_rx -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/uart_rx.sv
elaborate_design -golden -root {uart_rx} -rootonly 
...
set_analyze_option -mapping_file fv/uart_rx/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.uart_rx.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.uart_rx.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.uart_rx.rtl.fv_map.rpt
